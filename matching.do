...
cd "H:\My Documents\! Summer Project\statamatch"
...
run "`c(pwd)'\script\matchGU.do"
run "`c(pwd)'\script\matchbreast.do"
run "`c(pwd)'\script\matchlung.do"
run "`c(pwd)'\script\matchgynae.do"
run "`c(pwd)'\script\matchlowerGI.do"
